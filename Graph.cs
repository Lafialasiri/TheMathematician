    ...
    public class Graph
    {
        ...
        private void DrawingSurface_Paint(object sender, PaintEventArgs e)
        {
            ...
            using (Pen pen = new Pen(Color.Black))
            {
                ...
                if (Points.Count == 0)
                {
                    Rectangle rect = new Rectangle(DrawingSurface.Width / 2 - 100, DrawingSurface.Height / 2 - 20, 200, 40);
                    g.FillRectangle(Brushes.White, rect);
                    g.DrawRectangle(new Pen(Color.Black), rect); // Black Border
                    g.DrawString("No functions to Display.", new Font(Program.DefaultFonts[2], 12, FontStyle.Regular), Brushes.Red, new PointF(DrawingSurface.Width / 2 - 88, DrawingSurface.Height / 2 - 10));
                    return;
                }
